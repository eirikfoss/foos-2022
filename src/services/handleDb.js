...
const playerAPI = "http://foos.ddns.net:5000/players/";
const matchAPI = "http://foos.ddns.net:5000/matches/";
...
function getListOfMatches() {
  axios
    .get("http://foos.ddns.net:5000/matches/")
    .then(response => {
...
function getPrevMatches() {
  axios
    .get("http://foos.ddns.net:5000/prevmatches/")
    .then(response => {
...
function updateMatchInDb(newMatchData) {
  ...
  const url = "http://foos.ddns.net:5000/matches/update/" + id;
...
async function sendToPrevMatches(matchData) {
  ...
  await axios
    .post("http://foos.ddns.net:5000/prevMatches/add/", { match })
    .then(response => {
